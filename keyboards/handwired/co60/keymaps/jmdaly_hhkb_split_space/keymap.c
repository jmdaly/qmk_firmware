...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = LAYOUT_60_hhkb_split_625u_space( /* Base */
    ...
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(_L4),
             KC_LALT, KC_LGUI,       KC_ENT,              MO(_L4),       KC_SPC,  KC_LEAD, KC_RGUI, KC_RALT
  ),
  // Similar to the first layer, except that space and enter are flipped
  // on the split space keys.
  [_L2] = LAYOUT_60_hhkb_split_625u_space( /* Base */
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7, KC_8,    KC_9,    KC_0,    KC_MINS,    KC_EQL,  KC_BSLS, KC_GRV,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U, KC_I,    KC_O,    KC_P,    KC_LBRC,    KC_RBRC, KC_BSPC,
    CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J, KC_K,    KC_L,    KC_SCLN, KC_QUOT,    KC_ENT,
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(_L4),
             KC_LALT, KC_LGUI,       KC_SPC,              MO(_L4),       KC_ENT,  KC_LEAD, KC_RGUI, KC_RALT
  ),
  // My preferred base layout. This doesn't match the caps
  // on my boards, so I don't make it default.
  [_L3] = LAYOUT_60_hhkb_split_625u_space( /* Base */
  ...
  [_L4] = LAYOUT_60_hhkb_split_625u_space( /* Function */
    ...
    _______, BL_DEC,  _______, _______, _______, _______, _______, DF(_L1), DF(_L2), DF(_L3),   KC_PGDOWN, _______, _______,
