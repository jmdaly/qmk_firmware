...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L2] = KEYMAP_ANSI( /* Function layer */
      KC_TRNS, KC_F1,   KC_F2,   KC_F3, KC_F4, KC_F5, KC_F6,   KC_F7,   KC_F8, KC_F9,    KC_F10,  __x__,   __x__,   KC_DEL,  \
      ...
      KC_TRNS,    KC_VOLD, __x__, __x__, __x__, __x__,   __x__,   __x__, __x__,    __x__,   KC_PGDN, KC_TRNS,   \
      KC_TRNS, __x__, __x__,                          __x__,                             __x__,   __x__,   KC_TRNS, MO(_L3)  \
  ),

  [_L3] = KEYMAP_ANSI( /* System layer to have access to RESET button */
