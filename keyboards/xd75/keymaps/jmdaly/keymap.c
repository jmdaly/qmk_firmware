 ...
 */
 ...
 [_QW] = { /* QWERTY */
  { KC_GRV,        KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_MINS, KC_NLCK, KC_EQL,  KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_BSLS },
  { KC_TAB,        KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,   KC_LBRC, KC_INS,  KC_RBRC, KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_BSPC },
  { CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   KC_HOME, KC_DEL,  KC_PGUP, KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT },
  { KC_LSPO,       KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   KC_END,  KC_UP,   KC_PGDN, KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC },
  { MO(_FN),       KC_LGUI, KC_LALT, KC_ENT,  KC_ENT, KC_ENT, KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC, KC_SPC, KC_SPC,  KC_RALT, KC_RGUI, MO(_FN) },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  { RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_NLCK, KC_SLSH, KC_ASTR, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11 },
  ...
  { KC_TRNS, KC_TRNS, KC_TRNS, MO(_FN), KC_SPC, KC_SPC, KC_KP_0, KC_TRNS, KC_PDOT, KC_PENT, KC_TRNS, MO(_FN), KC_TRNS, KC_TRNS, KC_TRNS },
 }
};
